...
initialize_app(cred, {
    'databaseURL': 'https://automata-fb3f1-default-rtdb.firebaseio.com/'
})
...
# obtenemos una referencia a la Realtime Database de Firebase
ref = db.reference('Palabras')
